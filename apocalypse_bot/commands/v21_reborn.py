...
PATCH_HISTORY = [
    {
        "version": "7.1.0",
        "date": "2026-08-03",
        "title": "성장 루프 · 이모지 진행 상황 패치",
        "summary": "흩어진 출석·퀘스트·생활·전투·성장을 하나의 작전 보드로 연결하고 사진 없이 이모지 게이지로 진행·완료·보상을 표시합니다.",
        "points": [
            "!오늘할일·!성장보드에서 일일 6개·주간 6개 목표와 다음 추천 행동 통합 표시",
            "일일 6개 중 5개를 완료하면 유연하게 완주 처리하고 연속 달성 기록",
            "!미션보상에서 일일 보상과 주간 2/4/6단계 보상을 한 번에 정산",
            "누적 참여 점수 20·50·100·200·400 이정표 보상과 성장 인장 추가",
            "레이드·생활·탐색 장비 구성을 최대 3개 저장·적용하는 장비 프리셋",
            "월드보스 공격을 주차별로 집계하는 서버 랭킹과 지난주 순위 보상",
            "신규·14일 이상 복귀 생존자 따라잡기 보급",
