...
PATCH_HISTORY = [
    {
        "version": "6.3.2",
        "date": "2026-08-01",
        "title": "생활 콘텐츠 2차 비주얼 · 지원·탐색 상황 확장",
        "summary": "낚시·광산·코인·갈림길 탐색·돈주세요에 결과별 장면 이미지와 상황형 인카운트를 연결했습니다.",
        "points": [
            "낚시 12장·광산 12장·코인 6장·갈림길 탐색 6장·돈주세요 12장, 고유 장면 총 48장",
            "낚시·광산 성공·희귀 결과와 생활 숙련도·TIP·리액션 시각화",
            "코인 스캐너 진행·성공·희귀·실패 장면과 갈림길 탐색 성공·실패 장면 분리",
            "돈주세요를 보급 담당자·암시장 상인·버려진 배급소·사기 거래·특별 지원 물자로 확장",
            "낚시·광산·코인·탐색·지원 상황형 버튼 인카운트 12종",
            "신규 명령어와 신규 최상위 슬래시 명령 없음",
        ],
    },
    {
        "version": "6.3.1",
