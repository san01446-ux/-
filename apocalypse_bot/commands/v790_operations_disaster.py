...
class OperationsHubView(discord.ui.View):
    ...
    @discord.ui.button(label="문의·신고", emoji="🎫", style=discord.ButtonStyle.primary)
    ...
    @discord.ui.button(label="점검", emoji="🧪", style=discord.ButtonStyle.secondary)
    ...
    @discord.ui.button(label="통계", emoji="📊", style=discord.ButtonStyle.success)
    ...
    @discord.ui.button(label="알림", emoji="🔔", style=discord.ButtonStyle.primary)
    ...
    @discord.ui.button(label="재난", emoji="🚨", style=discord.ButtonStyle.danger)
...
class TempVoiceControlView(discord.ui.View):
    ...
    @discord.ui.button(label="방 잠금", emoji="🔒", style=discord.ButtonStyle.secondary)
    ...
    @discord.ui.button(label="이름 변경", emoji="✏️", style=discord.ButtonStyle.primary)
    ...
    @discord.ui.button(label="인원 제한", emoji="👥", style=discord.ButtonStyle.success)
